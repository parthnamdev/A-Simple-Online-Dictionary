...
function callPopUp() {
    ...
    if (wordNullCheck == 0) {
      ...
      var elements = document.getElementsById("popUp");
      ...
      if (elements_card.length > 0) {
        // elements_card[0].style.zIndex = "5";
        // elements_card[0].style.display = "block";
        elements_card[0].style.transition = "0.2s";
        elements_card[0].style.top = "180px";
        elements_card[0].style.boxShadow = "0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19)";
      }
      var elements_base_blur = document.getElementsByClassName("mainBody");
